...
ggplot(df, aes(x=sum_cases)) + geom_histogram(bins=100)
ggplot(df, aes(x=sum_deaths)) + geom_histogram(bins=100) 
...
#run this to display the CLM grapsh needed to verify CLM assumptions met
#par(mfrow = c(2, 2))
#plot(model)
