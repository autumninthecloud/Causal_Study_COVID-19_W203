...
df <- read.csv('/home/jovyan/r_bridge/code/lab-2-lab2_section8_jal/data/interim/covid_trips_interim.csv')
head(df)
...
# final_depRep_tab_df = dplyr::count(df, #df2, sort = TRUE)
# colnames(final_depRep_tab_df) <- c('County Type', 'Number of Samples')
# knitr::kable(final_depRep_tab_df, caption="Final Samples by County", align = "c")
```
...
ggpairs(df, columns = 1:ncol(data), title = "EDA: Variable Correlation",  
