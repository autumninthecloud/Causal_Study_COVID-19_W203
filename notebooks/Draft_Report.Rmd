...
df %>%
  ...
  select(long_trip, cases, deaths, median_income, unemp_rate, density, pct_lt17) %>%
  GGally::ggpairs(.,
...
model1 <- lm(log(long_trip) ~ log(cases+1) + log(deaths+1) + is_rural + median_income, data = df) #limited model
