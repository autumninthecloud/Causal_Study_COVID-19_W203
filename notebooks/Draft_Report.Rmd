...
```{r calc. coeff percents}
#Model 1
#when you compare a coeff for non-log x to a log y:
(1-exp(coef(model1)["is_rural"]))*100
#For every percent increase in x 'is rural', you get a #% outcome in number of long trips.

#Model 2
(1-exp(coef(model2)["is_rural"]))*100
#Model 3
(1-exp(coef(model3)["is_rural"]))*100


#Same for income

#Model 2
(1-exp(coef(model2)["log(median_income + 1)"]))*100
#Model 3
(1-exp(coef(model3)["log(median_income + 1)"]))*100

#Same for density

#Model 2
(1-exp(coef(model2)["log(density)"]))*100
#Model 3
(1-exp(coef(model3)["log(density)"]))*100

#Same for age 17 & 65
#Model 3
(1-exp(coef(model3)["log(lt17)"]))*100
(1-exp(coef(model3)["log(gt65)"]))*100
```
