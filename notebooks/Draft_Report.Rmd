...
For the analysis, we will create three models to understand if causal relationships exist between the outcome variable, the number of long distance trips, and the predictor variables per Texas county: income, population density, age, Covid-19 cases and deaths . We will use an indicator variable, rural counties, to compare performance of our models for rural or urban counties.
