...
table1::table1(~density + cases + median_income + lt17 + gt65 | rural_cat, data = df, topclass="Rtable1-zebra", overall = "Total")
...
Below are histograms of variables that did not follow normal distribution and required transformation. We applied a logarithmic transform to each of these variables, which can be seen in the collective Figure \@ref(tab:var-plots). *why logs*
