...
knitr::knit(output = "./../reports/final_report.pdf")
```
...
table1::table1(~total_pop + density + cases + unemp_rate + median_income + pct_lt17 + pct_gt65 | rural_cat, data = df, caption = "Table 1: Texas County Variable Statistics", topclass="Rtable1-zebra", overall = "Total")
